...
const CartPage = () => {
  const { cartAccessoryItems, addToCart, removeFromCart, getTotalCartAmount, accessoriesData } = useContext(ShopAccessoryContext);
    ...
    <section>
      <div className='pt-[105px]'>
        ...
        <table className='container mx-auto table-fixed border-separate border-spacing-2 border-2 rounded-lg border-gray-200 shadow-md'>
          {Object.keys(cartAccessoryItems).map((itemId, index) => {
